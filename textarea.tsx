...
>(({ className, ...props }, ref) => {
  return (
    <textarea
      ...
      ref={ref}
      {...props}
     data-aime-component-name="textarea"  data-aime-path-name="src/components/ui/textarea.tsx"  data-aime-column="5"  data-aime-line="10"  data-insp-path="src/components/ui/textarea.tsx:10:5:textarea" />
  )
})
