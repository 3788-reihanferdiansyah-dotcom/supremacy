...
function Badge({ className, variant, ...props }: BadgeProps) {
  return (
    <div className={cn(badgeVariants({ variant }), className)} {...props}  data-aime-component-name="div"  data-aime-path-name="src/components/ui/badge.tsx"  data-aime-column="5"  data-aime-line="32"  data-insp-path="src/components/ui/badge.tsx:32:5:div" />
  )
}
