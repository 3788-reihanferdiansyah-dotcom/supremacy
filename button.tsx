  ...
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        ref={ref}
        {...props}
       data-aime-component-name="Comp"  data-aime-path-name="src/components/ui/button.tsx"  data-aime-column="7"  data-aime-line="47"  data-insp-path="src/components/ui/button.tsx:47:7:Comp" />
    )
  }
)
