    ...
    <DayPicker
      ...
      components={{
        IconLeft: ({ className, ...props }) => (
          <ChevronLeft className={cn("h-4 w-4", className)} {...props}  data-aime-component-name="ChevronLeft"  data-aime-path-name="src/components/ui/calendar.tsx"  data-aime-column="11"  data-aime-line="62"  data-insp-path="src/components/ui/calendar.tsx:62:11:ChevronLeft" />
        ),
        IconRight: ({ className, ...props }) => (
          <ChevronRight className={cn("h-4 w-4", className)} {...props}  data-aime-component-name="ChevronRight"  data-aime-path-name="src/components/ui/calendar.tsx"  data-aime-column="11"  data-aime-line="65"  data-insp-path="src/components/ui/calendar.tsx:65:11:ChevronRight" />
        ),
      }}
      {...props}
     data-aime-component-name="DayPicker"  data-aime-path-name="src/components/ui/calendar.tsx"  data-aime-column="5"  data-aime-line="17"  data-insp-path="src/components/ui/calendar.tsx:17:5:DayPicker" />
  )
}
